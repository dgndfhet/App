...
html="<img src="http://fc4tn.baidu.com/it/u=2153153302,4007638258&fm=203&src=787&fc_m=cvican" alt="示例图片"><h1>11.1版本<h1/><br/>1.修复部位ini文件代码高亮失败<br/>2.修复代码中图像/音响无法快速预览<br/><br/><br/>"
